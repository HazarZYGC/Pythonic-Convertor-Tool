...
def main():
    if CONVERTION=='1':CSVtoXML()
    elif CONVERTION=='2':XMLtoCSV()
    elif CONVERTION=='3':CSVtoJSON()
    elif CONVERTION=='4':JSONtoCSV()
    elif CONVERTION=='5':XMLtoJSON()
    elif CONVERTION=='6':JSONtoXML()
    elif CONVERTION=='7':XMLtoCSV()
    else:
        print('Invalid operation number. Use these operation numbers:')
...
def XMLtoCSV():
    ...
    try:
        ...
        sys.exit(0)
    root = f.getroot()
    xmlschema_doc = etree.parse('DEPARTMENTS.xsd')
